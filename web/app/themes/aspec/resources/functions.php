...
function get_images_in_directory($directory) {
    ...
    $media_dir = $base_dir . "assets/images/$directory";
    $media_url = $base_url . "resources/assets/images/$directory";
...
function get_image_url($path) {
    return trailingslashit(get_stylesheet_directory_uri()) . "resources/assets/images/$path";
}
